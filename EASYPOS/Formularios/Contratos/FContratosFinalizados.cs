...
{
    public partial class FContratosFinalizados : Form
    {
       ...
       public  Contrato c = new Contrato();
        ...
        public FContratosFinalizados(Boolean seleccion=false,Boolean cotizaciones=false, Boolean pago=false)
        {
        ...
        private void cargar()
        {
                ...
                contratosBindingSource.DataSource = cContratos.ListadoFinalizados();
